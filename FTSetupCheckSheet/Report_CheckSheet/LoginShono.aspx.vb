...
Public Class LoginShono
    ...
    Protected Sub Submit_Click(sender As Object, e As EventArgs) Handles Submit.Click
        ...
        'Dim strSql As String = "UPDATE [dbo].[FTSetupReportHistory] Set [ConfirmedShonoOp] = @ConfirmedShonoOp WHERE LotNo  = '" & Request.QueryString("LotNo") & "' AND MCNo = '" & Request.QueryString("MCNo") & "'"
        'Dim ret As Integer
        ...
        Dim strSql1 As String = "UPDATE [dbo].[FTSetupReport] Set [ConfirmedShonoOp] = @ConfirmedShonoOp WHERE LotNo  = '" & Request.QueryString("LotNo") & "' AND MCNo = '" & Request.QueryString("MCNo") & "'"
        Dim ret1 As Integer
        Using con1 As SqlConnection = New SqlConnection(My.Settings.DBxConnectionString)
            Using cmd1 As SqlCommand = con1.CreateCommand()
                ...
                cmd1.Parameters.Add("@ConfirmedShonoOp", SqlDbType.VarChar, 15).Value = ConfirmedShonoOp
        ...
        testWriter.SetTextMatrix(362, 763)
        ...
        testWriter.SetTextMatrix(362, 740)
