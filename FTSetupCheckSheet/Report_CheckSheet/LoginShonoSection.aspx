<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LoginShonoSection.aspx.vb" Inherits="Report_CheckSheet.LoginShonoSection" %>
    	...
    	<div class="col-md-4 col-md-offset-4" style="left: 0px; top: 20px">
    		<div class="panel panel-default">
			  	<div class="panel-heading">
			    	<h3 class="panel-title">( Section ) Please Log in&nbsp; :&nbsp;
                ...
                <div class="panel-group">             
                    <div class="panel panel-danger" id="panelError" runat="server" style="display:none">
                        ...
                        <asp:Label ID="ErrorMessageLabel" runat="server" Text="THERE IS ERROR MESSAGE !!!!" ForeColor="Red" Font-Size="Medium"></asp:Label>
                    </div>
                </div>
