<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ShowDataSetup2.aspx.vb" Inherits="Report_CheckSheet.ShowDataSetup2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ul class="nav nav-pills nav-justified">
        <li><a href="ShowDataSetup2.aspx">Show Data History</a></li>
        <li class="active"><a href="ShowDataSetup2.aspx">Show Data</a></li>
    </ul>
    ...
    <style>
     ...
     <div class="form-group ">
        ...
        <br />
        <br />
        <table style="text-align: center; width: 1097px;" class="auto-style5">
            <tr>
                <td>
        ...
        <div class="auto-style4">
            ...
            <asp:GridView ID="dataCheckSheetGridView" runat="server" AutoGenerateColumns="False"
                ...
                BorderWidth="3px" CellPadding="3" ForeColor="Black" AllowPaging="True" Font-Names="Verdana" GridLines="Vertical" >
