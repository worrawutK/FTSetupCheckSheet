   ...
   Plugin.prototype =
           {
              ...
              showDate: function (date)
              {
                 if (date)
                 {
                    this.$dtpElement.find('.dtp-actual-day').html(date.locale(this.params.lang).format('dd'));
                    this.$dtpElement.find('.dtp-actual-month').html(date.locale(this.params.lang).format('MM').toUpperCase());
              ...
              toggleTime: function (value, isHours)
              {
                 ...
                 if (isHours)
                 {
                    ...
                    _date.hour(this.convertHours(value)).minute(0).second(0).millisecond(0);

                    result = !(this.isAfterMinDate(_date, true, false) === false || this.isBeforeMaxDate(_date, true, false) === false);
                 } else
                 {
                    var _date = moment(this.currentDate);
                    _date.minute(value).second(0).millisecond(0);
