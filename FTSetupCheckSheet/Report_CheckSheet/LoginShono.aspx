<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LoginShono.aspx.vb" Inherits="Report_CheckSheet.LoginShono" %>
    	...
    	<div class="col-md-4 col-md-offset-4" style="left: 0px; top: 20px">
    		<div class="panel panel-default">
			  	<div class="panel-heading">
			    	<h3 class="panel-title">( OPNo. ) Please Log in&nbsp; :&nbsp;
