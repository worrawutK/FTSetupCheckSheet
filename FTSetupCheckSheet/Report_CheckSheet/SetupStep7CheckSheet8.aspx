<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="SetupStep7CheckSheet8.aspx.vb" Inherits="Report_CheckSheet.SetupStep7CheckSheet8" %>
     ...
     <div class="container">  
         <div class="panel-group">
            <div class="panel panel-primary">
              <div class="panel-heading"> มาตราการของ ＢＧＡ PKG (ＢＧＡ項目) </div>
            </div><br />

     <div class="panel panel-info">
              <div class="panel-heading"> (24) Small Ball (ﾎﾞｰﾙつぶれは) </div>
                  <div class="form-group">
                      <select runat="server" class="form-control" id="selecBgaSmallBall">
                        <option>   </option>
       ...
       <div class="panel panel-info">
              <div class="panel-heading"> (25) Bent Tape (ﾃｰﾌﾟ曲りは) </div>
                  <div class="form-group">
                      <select runat="server" class="form-control" id="selelBgaBentTape">
                        <option>   </option>
                        <option value ="A">A</option>
                        <option value ="B">B</option>
                        <option value ="C">C</option>
