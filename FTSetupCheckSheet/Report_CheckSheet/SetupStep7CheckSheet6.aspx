<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="SetupStep7CheckSheet6.aspx.vb" Inherits="Report_CheckSheet.SetupStep7CheckSheet6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">        
     ...
     <div class="container">  
         <div class="panel-group">
           ...
           <div class="panel panel-danger">
              <div class="panel-heading"> (19) Good Sample  (良品)  </div>
                  <div class="form-group">
                      <select runat="server" class="form-control" id="selecPkgGoodjudgement">
                        <option>   </option>
     ...
     <div class="panel panel-danger">
              <div class="panel-heading"> (20) NG Sample (不良品)  </div>
                  <div class="form-group">
                      <select runat="server" class="form-control" id="selecPkgNGjudgement">
                        <option>   </option>
                        <option value ="OK">OK</option>
                        <option value ="NG">NG</option>
                      </select>
      ...
      <div class="panel panel-danger">
              <div class="panel-heading"> (21) การใช้ Nishiki camara หรือไม่ ? (認識ｶﾒﾗ)   </div>
                  <div class="form-group">
                      <select runat="server" class="form-control" id="SelectPKgNishikijudgement">
                        <option>   </option>
                        <option value ="OK">OK</option>
                        <option value ="NG">NG</option>
                      </select>
